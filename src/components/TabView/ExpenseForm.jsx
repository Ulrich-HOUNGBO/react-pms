        ...
        <form  className="row gap-3">
            ...
            <div className="row">
                <div className="col-md-6 ">
                    <div className="flex flex-column gap-2">
                        ...
                        <Calendar value={datePaid} onChange={(e) => setDatePaid(e.value)} showIcon />
                    </div>
                </div>
            ...
            <div className="row p-fluid mt-5">
                ...
                <div className="col-md-5">
                    <Button label="Add New Expense" className="p-fluid" type="submit" icon="pi pi-send" size="small" severity={"success"} />
                </div>
                <div className="col-md-5">
